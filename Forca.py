...
if __name__ == "__main__":
    ...
    adicionar_palavra_e_dica("elefante", "O maior animal terrestre", "animal")
    adicionar_palavra_e_dica("leao", "O rei da selva", "animal")
    adicionar_palavra_e_dica("abacaxi", "Uma fruta tropical com casca espinhosa", "Fruta")
    adicionar_palavra_e_dica("morango", "Pequena, vermelha e deliciosa", "Fruta")
